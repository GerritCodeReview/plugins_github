...
/**
 * Handles webhook callbacks sent from Github.
 * Delegates requests to implementations of {@link EventHandler}.
 */
@Singleton
public class WebhookServlet extends HttpServlet {
  ...
  @Inject
  public WebhookServlet(final UserScopedProvider<GitHubLogin> loginProvider,
      final ScopedProvider<GitHubLogin> requestScopedLoginProvider,
  ...
  protected void doPost(HttpServletRequest req, HttpServletResponse resp)
    ...
    if (login == null || !login.isLoggedIn()) {
      logger.error(
          "Cannot loging to github as {}. {}.webhookUser is not correctly configured?",
