...
public class JobStatusController {
  ...
  protected void respondWithJobStatusJson(HttpServletResponse resp, BatchImporter cloner)
      throws IOException {
    List<GitJob> jobs = cloner.getJobs();
    List<GitJobStatus> jobListStatus =
        Lists.transform(jobs, new Function<GitJob, GitJobStatus>() {
          @Override
          public GitJobStatus apply(GitJob job) {
