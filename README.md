...
References:
- [1] [GitHub OAuth App Authorization Flow](https://docs.github.com/en/apps/oauth-apps/building-oauth-apps/authorizing-oauth-apps#web-application-flow)
- [2] [GitHub OAuth Redirect URLs](https://docs.github.com/en/apps/oauth-apps/building-oauth-apps/authorizing-oauth-apps#redirect-urls)
- [3] [Gerrit Configuration Documentation](https://gerrit-review.googlesource.com/Documentation/config-gerrit.html)
- [4] [RFC 7239 - Forwarded HTTP Extension](https://www.rfc-editor.org/rfc/rfc7239.html)
