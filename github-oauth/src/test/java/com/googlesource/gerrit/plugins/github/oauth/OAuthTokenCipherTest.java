...
public class OAuthTokenCipherTest {
  ...
  public static void setupDefaultKeyProvider() throws IOException {
    defaultKeyProvider = new DefaultKeyProvider(temporaryFolder.newFolder().toPath());
  }
  ...
  @Test
  public void shouldEncryptAndDecryptATokenWithDefaultKey() throws IOException {
    verifyTokenEncryptionAndDecryption(objectUnderTest(createCommonConfig()));
  }
  ...
  private OAuthTokenCipher objectUnderTest(Config testConfig) throws IOException {
    return new OAuthTokenCipher(
        new GitHubOAuthConfig(testConfig, defaultKeyProvider, canonicalWebUrl));
  }
