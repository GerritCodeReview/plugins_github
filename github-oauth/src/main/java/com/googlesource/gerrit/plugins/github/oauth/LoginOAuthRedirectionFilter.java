...
public class LoginOAuthRedirectionFilter implements Filter {
  ...
  /**
   * This method extract the client host.
   *
   * @param hosts String that represents a list of hosts, i.e "test.example.io,
   *     subdomain1.example.io" where the first host represents the client host
   * @return return Optional with the value clientHost if exists otherwise Optional.empty
   */
